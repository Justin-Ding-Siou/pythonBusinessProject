...
# 上傳前要改為，news.txt 原檔名
with open("C://Users/Ting/PycharmProjects/pythonBusinessProject/2021_TEST02/TEST2_PRACTICE/news.txt", encoding='utf-8') as f:
  news = f.read()
